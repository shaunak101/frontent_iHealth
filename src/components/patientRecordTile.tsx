...
function DoctorRecordTile(props:any){
    ...
    return(
    <a onClick={click} className="h-40 px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
        <div onClick={click} className="flex flex-row sm:-mx-4">
...
export default DoctorRecordTile;
